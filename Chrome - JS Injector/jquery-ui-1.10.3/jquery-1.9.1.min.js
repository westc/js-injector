...
return a},each:function(a,b){return c.each(this,a,b)},ready:function(a){c.ready.promise().done(a);return this},slice:function(){return this.pushStack(U.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},eq:function(a){var b=this.length;a=+a+(0>a?b:0);return this.pushStack(0<=a&&a<b?[this[a]]:[])},map:function(a){return this.pushStack(c.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:Da,
...
a.nodeName.toLowerCase()===b.toLowerCase()},each:function(a,b,c){var e,f=0,g=a.length;e=va(a);if(c)if(e)for(;f<g&&(e=b.apply(a[f],c),!1!==e);f++);else for(f in a){if(e=b.apply(a[f],c),!1===e)break}else if(e)for(;f<g&&(e=b.call(a[f],f,a[f]),!1!==e);f++);else for(f in a)if(e=b.call(a[f],f,a[f]),!1===e)break;return a},trim:Ea&&!Ea.call("\ufeff\u00a0")?function(a){return null==a?"":Ea.call(a)}:function(a){return null==a?"":(a+"").replace(ec,"")},makeArray:function(a,b){var d=b||[];null!=a&&(va(Object(a))?
...
f.get(a,b))?e:a[b]}},propHooks:{tabIndex:{get:function(a){var b=a.getAttributeNode("tabindex");return b&&b.specified?parseInt(b.value,10):oc.test(a.nodeName)||pc.test(a.nodeName)&&a.href?0:n}}}});wb={get:function(a,b){var d=c.prop(a,b),e="boolean"===typeof d&&a.getAttribute(b);return(d="boolean"===typeof d?Ha&&B?null!=e:Ga.test(b)?a[c.camelCase("default-"+b)]:!!e:a.getAttributeNode(b))&&!1!==d.value?b.toLowerCase():n},set:function(a,b,d){!1===b?c.removeAttr(a,d):Ha&&B||!Ga.test(d)?a.setAttribute(!B&&
...
a)?[b[0]]:[]:c.find.matches(a,b)},dir:function(a,b,d){var e=[];for(a=a[b];a&&9!==a.nodeType&&(d===n||1!==a.nodeType||!c(a).is(d));)1===a.nodeType&&e.push(a),a=a[b];return e},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)1===a.nodeType&&a!==b&&c.push(a);return c}});var Za="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",vc=/ jQuery\d+="(?:null|\d+)"/g,Cb=RegExp("<(?:"+Za+")[\\s/>]","i"),
La=/^\s+/,Db=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,Eb=/<([\w:]+)/,Fb=/<tbody/i,wc=/<|&#?\w+;/,xc=/<(?:script|style|link)/i,za=/^(?:checkbox|radio)$/i,yc=/checked\s*(?:[^=]|=\s*.checked.)/i,Gb=/^$|\/(?:java|ecma)script/i,Vb=/^true\/(.*)/,zc=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,F={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],area:[1,"<map>","</map>"],param:[1,"<object>","</object>"],thead:[1,"<table>","</table>"],
...
ya(A(d,"script")),d.parentNode.removeChild(d));return this},empty:function(){for(var a,b=0;null!=(a=this[b]);b++){for(1===a.nodeType&&c.cleanData(A(a,!1));a.firstChild;)a.removeChild(a.firstChild);a.options&&c.nodeName(a,"select")&&(a.options.length=0)}return this},clone:function(a,b){a=null==a?!1:a;b=null==b?a:b;return this.map(function(){return c.clone(this,a,b)})},html:function(a){return c.access(this,function(a){var d=this[0]||{},e=0,f=this.length;if(a===n)return 1===d.nodeType?d.innerHTML.replace(vc,
""):n;if("string"===typeof a&&!(xc.test(a)||!c.support.htmlSerialize&&Cb.test(a)||!c.support.leadingWhitespace&&La.test(a)||F[(Eb.exec(a)||["",""])[1].toLowerCase()])){a=a.replace(Db,"<$1></$2>");try{for(;e<f;e++)d=this[e]||{},1===d.nodeType&&(c.cleanData(A(d,!1)),d.innerHTML=a);d=0}catch(g){}}d&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){c.isFunction(a)||"string"===typeof a||(a=c(a).not(this).detach());return this.domManip([a],!0,function(a){var d=this.nextSibling,
e=this.parentNode;e&&(c(this).remove(),e.insertBefore(a,d))})},detach:function(a){return this.remove(a,!0)},domManip:function(a,b,d){a=sb.apply([],a);var e,f,g,h,k=0,l=this.length,q=this,p=l-1,m=a[0],u=c.isFunction(m);if(u||!(1>=l||"string"!==typeof m||c.support.checkClone)&&yc.test(m))return this.each(function(c){var e=q.eq(c);u&&(a[0]=m.call(this,c,b?e.html():n));e.domManip(a,b,d)});if(l&&(h=c.buildFragment(a,this[0].ownerDocument,!1,this),e=h.firstChild,1===h.childNodes.length&&(h=e),e)){b=b&&
c.nodeName(e,"tr");g=c.map(A(h,"script"),$a);for(f=g.length;k<l;k++)e=h,k!==p&&(e=c.clone(e,!0,!0),f&&c.merge(g,A(e,"script"))),d.call(b&&c.nodeName(this[k],"table")?Ub(this[k],"tbody"):this[k],e,k);if(f)for(h=g[g.length-1].ownerDocument,c.map(g,ab),k=0;k<f;k++)e=g[k],Gb.test(e.type||"")&&!c._data(e,"globalEval")&&c.contains(h,e)&&(e.src?c.ajax({url:e.src,type:"GET",dataType:"script",async:!1,global:!1,"throws":!0}):c.globalEval((e.text||e.textContent||e.innerHTML||"").replace(zc,"")));h=e=null}return this}});
...
if(!(c.support.noCloneEvent&&c.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||c.isXMLDoc(a)))for(e=A(g),k=A(a),h=0;null!=(f=k[h]);++h)if(e[h]){var q=e[h],n=void 0,m=void 0,p=void 0;if(1===q.nodeType){n=q.nodeName.toLowerCase();if(!c.support.noCloneEvent&&q[c.expando]){p=c._data(q);for(m in p.events)c.removeEvent(q,m,p.handle);q.removeAttribute(c.expando)}if("script"===n&&q.text!==f.text)$a(q).text=f.text,ab(q);else if("object"===n)q.parentNode&&(q.outerHTML=f.outerHTML),c.support.html5Clone&&
f.innerHTML&&!c.trim(q.innerHTML)&&(q.innerHTML=f.innerHTML);else if("input"===n&&za.test(f.type))q.defaultChecked=q.checked=f.checked,q.value!==f.value&&(q.value=f.value);else if("option"===n)q.defaultSelected=q.selected=f.defaultSelected;else if("input"===n||"textarea"===n)q.defaultValue=f.defaultValue}}if(b)if(d)for(k=k||A(a),e=e||A(g),h=0;null!=(f=k[h]);h++)bb(f,e[h]);else bb(a,g);e=A(g,"script");0<e.length&&ya(e,!l&&A(a,"script"));return g},buildFragment:function(a,b,d,e){for(var f,g,h,k,l,q,
n=a.length,m=Ya(b),p=[],r=0;r<n;r++)if((g=a[r])||0===g)if("object"===c.type(g))c.merge(p,g.nodeType?[g]:g);else if(wc.test(g)){h=h||m.appendChild(b.createElement("div"));k=(Eb.exec(g)||["",""])[1].toLowerCase();q=F[k]||F._default;h.innerHTML=q[1]+g.replace(Db,"<$1></$2>")+q[2];for(f=q[0];f--;)h=h.lastChild;!c.support.leadingWhitespace&&La.test(g)&&p.push(b.createTextNode(La.exec(g)[0]));if(!c.support.tbody)for(f=(g="table"!==k||Fb.test(g)?"<table>"!==q[1]||Fb.test(g)?0:h:h.firstChild)&&g.childNodes.length;f--;)c.nodeName(l=
g.childNodes[f],"tbody")&&!l.childNodes.length&&g.removeChild(l);c.merge(p,h.childNodes);for(h.textContent="";h.firstChild;)h.removeChild(h.firstChild);h=m.lastChild}else p.push(b.createTextNode(g));h&&m.removeChild(h);c.support.appendChecked||c.grep(A(p,"input"),Wb);for(r=0;g=p[r++];)if(!e||-1===c.inArray(g,e))if(a=c.contains(g.ownerDocument,g),h=A(m.appendChild(g),"script"),a&&ya(h),d)for(f=0;g=h[f++];)Gb.test(g.type||"")&&d.push(g);return m},cleanData:function(a,b){for(var d,e,f,g,h=0,k=c.expando,
l=c.cache,q=c.support.deleteExpando,n=c.event.special;null!=(d=a[h]);h++)if(b||c.acceptData(d))if(g=(f=d[k])&&l[f]){if(g.events)for(e in g.events)n[e]?c.event.remove(d,e):c.removeEvent(d,e,g.handle);l[f]&&(delete l[f],q?delete d[k]:typeof d.removeAttribute!==y?d.removeAttribute(k):d[k]=null,G.push(f))}}});var ea,R,S,Na=/alpha\([^)]*\)/i,Ac=/opacity\s*=\s*([^)]*)/,Bc=/^(top|right|bottom|left)$/,Cc=/^(none|table(?!-c[ea]).+)/,Hb=/^margin/,Xb=RegExp("^("+na+")(.*)$","i"),ba=RegExp("^("+na+")(?!px)[a-z%]+$",
"i"),Dc=RegExp("^([+-])=("+na+")","i"),jb={BODY:"block"},Ec={position:"absolute",visibility:"hidden",display:"block"},Ib={letterSpacing:0,fontWeight:400},Q=["Top","Right","Bottom","Left"],db=["Webkit","O","Moz","ms"];c.fn.extend({css:function(a,b){return c.access(this,function(a,b,f){var g,h={},k=0;if(c.isArray(b)){g=R(a);for(f=b.length;k<f;k++)h[b[k]]=c.css(a,b[k],!1,g);return h}return f!==n?c.style(a,b,f):c.css(a,b)},a,b,1<arguments.length)},show:function(){return eb(this,!0)},hide:function(){return eb(this)},
toggle:function(a){var b="boolean"===typeof a;return this.each(function(){(b?a:P(this))?c(this).show():c(this).hide()})}});c.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=S(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":c.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,b,d,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var f,g,h,k=c.camelCase(b),l=
a.style;b=c.cssProps[k]||(c.cssProps[k]=cb(l,k));h=c.cssHooks[b]||c.cssHooks[k];if(d!==n){if(g=typeof d,"string"===g&&(f=Dc.exec(d))&&(d=(f[1]+1)*f[2]+parseFloat(c.css(a,b)),g="number"),!(null==d||"number"===g&&isNaN(d)||("number"!==g||c.cssNumber[k]||(d+="px"),c.support.clearCloneStyle||""!==d||0!==b.indexOf("background")||(l[b]="inherit"),h&&"set"in h&&(d=h.set(a,d,e))===n)))try{l[b]=d}catch(q){}}else return h&&"get"in h&&(f=h.get(a,!1,e))!==n?f:l[b]}},css:function(a,b,d,e){var f,g;g=c.camelCase(b);
b=c.cssProps[g]||(c.cssProps[g]=cb(a.style,g));(g=c.cssHooks[b]||c.cssHooks[g])&&"get"in g&&(f=g.get(a,!0,d));f===n&&(f=S(a,b,e));"normal"===f&&b in Ib&&(f=Ib[b]);return""===d||d?(a=parseFloat(f),!0===d||c.isNumeric(a)?a||0:f):f},swap:function(a,b,c,e){var f,g={};for(f in b)g[f]=a.style[f],a.style[f]=b[f];c=c.apply(a,e||[]);for(f in b)a.style[f]=g[f];return c}});r.getComputedStyle?(R=function(a){return r.getComputedStyle(a,null)},S=function(a,b,d){var e,f=(d=d||R(a))?d.getPropertyValue(b)||d[b]:n,
g=a.style;d&&(""!==f||c.contains(a.ownerDocument,a)||(f=c.style(a,b)),ba.test(f)&&Hb.test(b)&&(a=g.width,b=g.minWidth,e=g.maxWidth,g.minWidth=g.maxWidth=g.width=f,f=d.width,g.width=a,g.minWidth=b,g.maxWidth=e));return f}):p.documentElement.currentStyle&&(R=function(a){return a.currentStyle},S=function(a,b,c){var e,f,g=(c=c||R(a))?c[b]:n,h=a.style;null==g&&h&&h[b]&&(g=h[b]);if(ba.test(g)&&!Bc.test(b)){c=h.left;if(f=(e=a.runtimeStyle)&&e.left)e.left=a.currentStyle.left;h.left="fontSize"===b?"1em":g;
g=h.pixelLeft+"px";h.left=c;f&&(e.left=f)}return""===g?"auto":g});c.each(["height","width"],function(a,b){c.cssHooks[b]={get:function(a,e,f){if(e)return 0===a.offsetWidth&&Cc.test(c.css(a,"display"))?c.swap(a,Ec,function(){return ib(a,b,f)}):ib(a,b,f)},set:function(a,e,f){var g=f&&R(a);return gb(a,e,f?hb(a,b,f,c.support.boxSizing&&"border-box"===c.css(a,"boxSizing",!1,g),g):0)}}});c.support.opacity||(c.cssHooks.opacity={get:function(a,b){return Ac.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||
"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var d=a.style,e=a.currentStyle,f=c.isNumeric(b)?"alpha(opacity="+100*b+")":"",g=e&&e.filter||d.filter||"";d.zoom=1;if((1<=b||""===b)&&""===c.trim(g.replace(Na,""))&&d.removeAttribute&&(d.removeAttribute("filter"),""===b||e&&!e.filter))return;d.filter=Na.test(g)?g.replace(Na,f):g+" "+f}});c(function(){c.support.reliableMarginRight||(c.cssHooks.marginRight={get:function(a,b){if(b)return c.swap(a,{display:"inline-block"},S,[a,"marginRight"])}});
...
b){return this.mouseenter(a).mouseleave(b||a)};var aa,W,Oa=c.now(),Pa=/\?/,Ic=/#.*$/,Kb=/([?&])_=[^&]*/,Jc=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,Kc=/^(?:GET|HEAD)$/,Lc=/^\/\//,Lb=/^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,Mb=c.fn.load,Nb={},Ba={},Ob="*/".concat("*");try{W=ac.href}catch(Qc){W=p.createElement("a"),W.href="",W=W.href}aa=Lb.exec(W.toLowerCase())||[];c.fn.load=function(a,b,d){if("string"!==typeof a&&Mb)return Mb.apply(this,arguments);var e,f,g,h=this,k=a.indexOf(" ");0<=k&&(e=a.slice(k,a.length),
...
c.etag[g]&&v.setRequestHeader("If-None-Match",c.etag[g]));(m.data&&m.hasContent&&!1!==m.contentType||b.contentType)&&v.setRequestHeader("Content-Type",m.contentType);v.setRequestHeader("Accept",m.dataTypes[0]&&m.accepts[m.dataTypes[0]]?m.accepts[m.dataTypes[0]]+("*"!==m.dataTypes[0]?", "+Ob+"; q=0.01":""):m.accepts["*"]);for(f in m.headers)v.setRequestHeader(f,m.headers[f]);if(m.beforeSend&&(!1===m.beforeSend.call(r,v,m)||2===M))return v.abort();G="abort";for(f in{success:1,error:1,complete:1})v[f](m[f]);
if(q=mb(Ba,m,b,v)){v.readyState=1;l&&E.trigger("ajaxSend",[v,m]);m.async&&0<m.timeout&&(k=setTimeout(function(){v.abort("timeout")},m.timeout));try{M=1,q.send(B,d)}catch(t){if(2>M)d(-1,t);else throw t;}}else d(-1,"No Transport");return v},getScript:function(a,b){return c.get(a,n,b,"script")},getJSON:function(a,b,d){return c.get(a,b,d,"json")}});c.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/(?:java|ecma)script/},
...
"string"===typeof h.responseText&&(r.text=h.responseText);try{p=h.statusText}catch(z){p=""}k||!a.isLocal||a.crossDomain?1223===k&&(k=204):k=r.text?200:404}}catch(y){g||e(-1,y)}r&&e(k,p,r,m)};a.async?4===h.readyState?setTimeout(b):(f=++Mc,Ra&&(X||(X={},c(r).unload(Ra)),X[f]=b),h.onreadystatechange=b):b()},abort:function(){b&&b(n,!0)}}}});var T,ta,Nc=/^(?:toggle|show|hide)$/,Oc=RegExp("^(?:([+-])=|)("+na+")([a-z%]*)$","i"),Pc=/queueHooks$/,ja=[function(a,b,d){var e,f,g,h,k,l,q=this,n=a.style,m={},p=
